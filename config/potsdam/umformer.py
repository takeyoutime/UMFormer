...
weights_name = "umformer-r18-512-crop-ms-e105"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "umformer-r18-512-crop-ms-e105"
...
loss = DiceLoss(smooth=0.05, ignore_index=ignore_index)
use_aux_loss = False
...
# test_dataset = PotsdamDataset(data_root='data/potsdam/images',
#                               transform=val_aug)
...
# num_train_optimization_steps = int(len(train_dataset) / train_batch_size / 1) * 105
